...
- [Controller & peripheral platform](hardware/controller_platform.md) — RTC, GPS, MCU, audio/PTT, storage, USB power, RF sensing, status LEDs, TX safety, frequency/tone plan, LoRa (skipped), enclosure — planned, not yet in the schematic
