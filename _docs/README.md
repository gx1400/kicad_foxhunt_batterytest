...
- [Audio / PTT path — I2S DAC, ESP32-S3, SA818S, external HT](hardware/audio_ptt_path.md) — PCM5102A DAC + attenuator implemented; SA818S and the external-HT jack itself still planning-only
