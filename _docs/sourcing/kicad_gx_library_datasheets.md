...
`pcb/libs/kicad_gx_library/symbols/GX.kicad_sym` (not to be confused with symbols that merely
...
`pcb/libs/kicad_gx_library/datasheets/`, and link it both at the library-symbol-default level
