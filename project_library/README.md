...
- `datasheets/` — PDF datasheets for placed components, organized into per-manufacturer
  ...
  `_docs/sourcing/project_library_datasheets.md` for the full part-to-file mapping, including two
...
- `3dmodels/` — downloaded 3D models (STEP preferred) for manual placement/alignment.
  ...
  `_docs/sourcing/3d_models.md` for status (covers both `kicad_gx_library` and this directory).
